...
# except for years that are exactly divisible by 100, but these centurial years are leap years if they are exactly divisible by 400.1985


#stack overflow helped me with the code structure a bit but used nesting "if" and I'm not quite there. 
#struggling with vscode to check my code. hope this works. *will jump into live office hours to "fix" my vscode 
